...
$res = mysql_query("UPDATE payment SET name='".$name."', ins='".$ins."', need='".$need."' WHERE id='".$iidd."'");
echo mysql_error();
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT name, ins, need FROM payment WHERE id='".$iidd."'"));
?>  								
