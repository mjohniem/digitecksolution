...
$res = mysql_query("UPDATE subcat SET name='".$name."', parent='".$parent."' WHERE id='".$iidd."'");
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT name, parent FROM subcat WHERE id='".$iidd."'"));
...
$parent = mysql_fetch_array(mysql_query("SELECT name FROM cat WHERE id='".$old[1]."'"));
