...
$res = mysql_query("INSERT INTO slider_cat SET img='".$bgimg."', btxt='".$btxt."', stxt='".$stxt."'");
echo mysql_error();
if($res){
...
$exist = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM slider_cat WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysql_query("DELETE FROM slider_cat WHERE id='".$did."'");
