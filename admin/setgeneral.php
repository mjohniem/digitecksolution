...
$res = mysql_query("UPDATE general_setting SET sitename='".$name."', wcmsg='".$wcmsg."', address='".$address."', mobile='".$mobile."', email='".$email."', currency='".$currency."' WHERE id='1'");
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT `sitename`, `wcmsg`, `address`, `mobile`, `email`, `currency` FROM general_setting WHERE id='1'"));
