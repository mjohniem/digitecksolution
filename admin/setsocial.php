...
$li = mysql_real_escape_string($_POST["li"]);
...
$res = mysql_query("UPDATE social SET fb='".$fb."', tw='".$tw."', gp='".$gp."', li='".$li."', yt='".$yt."' WHERE id='1'");
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT fb, tw, gp, li, yt FROM social WHERE id='1'"));
