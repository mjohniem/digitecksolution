...
$fnl = "$dt$random$ok";
 ...
 //$aa = "$aa,$newFileName";     
$cou++;
mysql_query("INSERT INTO moreimg SET assignto='".$iidd."', img='".$newFileName."'");
echo mysql_error();
...
if(isset($_GET['did'])) {
$did = $_GET["did"];
$exist = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM moreimg WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysql_query("DELETE FROM moreimg WHERE id='".$did."'");
...
$ddaa = mysql_query("SELECT id, img FROM moreimg WHERE assignto='".$iidd."' ORDER BY id");
