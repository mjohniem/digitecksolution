...
$fnl = "$dt$random$ok";
 ...
 //$aa = "$aa,$newFileName";     
$cou++;
mysql_query("INSERT INTO brand_logo SET img='".$newFileName."'");
echo mysql_error();
...
$exist = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM brand_logo WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysql_query("DELETE FROM brand_logo WHERE id='".$did."'");
